...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra(CProfileActivity.EVENT_ID));
        ...
        textViewArtist.setText(intent.getStringExtra(CProfileActivity.EVENT_NAME));
